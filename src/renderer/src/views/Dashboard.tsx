  ...
  return (
    <div className="flex-1 p-4 bg-white/2 grid grid-cols-12 gap-4 h-full overflow-hidden relative animate-in fade-in zoom-in duration-300 w-full">
      ...
      <div className="col-span-12 lg:col-span-6 relative flex flex-col items-center justify-center">
        ...
        {/* Dignified Speech Recognition Hover Overlay */}
        {!isMicMuted && isSystemActive && (
          <div className="absolute bottom-28 z-50 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="bg-zinc-950/80 backdrop-blur-2xl border border-emerald-500/30 rounded-2xl px-6 py-3 max-w-md shadow-[0_0_30px_rgba(16,185,129,0.15)] flex flex-col gap-2">
              <div className="flex items-center gap-3 border-b border-emerald-500/10 pb-1.5">
                <div className="flex items-end gap-0.5 h-3.5">
                  <span className="w-0.5 h-3.5 bg-emerald-400 rounded-full animate-[soundwave_0.8s_ease-in-out_infinite]" />
                  <span className="w-0.5 h-2 bg-emerald-400 rounded-full animate-[soundwave_0.8s_ease-in-out_infinite_0.15s]" />
                  <span className="w-0.5 h-4 bg-emerald-400 rounded-full animate-[soundwave_0.8s_ease-in-out_infinite_0.3s]" />
              ...
              <p className="text-[11px] font-mono font-semibold text-zinc-100 leading-relaxed text-center break-words min-w-[280px] max-w-sm">
                {interimSpeech || "Awaiting voice signature..."}
              </p>
              
              {/* Intelligent Watchdog Progress Indicator */}
              {interimSpeech && (
